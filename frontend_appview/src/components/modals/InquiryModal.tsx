            ...
            <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-7 pt-2">
              ...
              <div className="pt-2">
                <button
                  ...
                  className="w-full py-3.5 bg-[#3c0b1e] hover:bg-[#4f1028] text-white text-xs font-mono uppercase tracking-[0.18em] transition-all flex items-center justify-center gap-2.5 rounded-xl cursor-pointer shadow-md hover:shadow-lg disabled:opacity-50 active:scale-[0.99]"
                >
